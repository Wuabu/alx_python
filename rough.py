...
age =[23,45,75,345,23,45,76,]
fruits.append("Apples")
fruits.append('Grapes')
fruits.extend('Kiwi')
fruits.remove('Banana')
fruits.insert(0, "Pineaples")
fruits.insert(4, "Pineaples")
fruits.pop(5)
fruits.index('Pineaples')
fruits.sort()
age.sort()
# fruits.count('pineapples')
# fruits.count("Pineaples")
# a=fruits.count("Pineaples")
print (fruits)
print (age)
